...
{
    [Tool]
    public class StateScriptNode : GraphNode
    {
        ...
        public override void _Ready()
        {
            ...
            var infoColor = BorderColor.Lightened(0.4f); //new Color("#42ffd6");
        ...
        public override void _Process(float delta)
        {
            ...
            _labelVBox.RectGlobalPosition = RectGlobalPosition - new Vector2(0, _labelVBox.RectSize.y + LabelVBoxOffset);
            _commentLabel.Visible = _commentLabel.Text != "";
            _infoLabel.Visible = _infoLabel.Text != "";
        }

        public void UpdateStyleboxes()
        {
